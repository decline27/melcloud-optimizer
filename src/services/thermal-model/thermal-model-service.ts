...
export class ThermalModelService {
  ...
  public getOptimalPreheatingTime(
    ...
    try {
      ...
      return DateTime.fromISO(targetTime).minus({ hours: 2 }).toISO();
    }
  }
    ...
    try {
      ...
      if (inCheapPeriod && upcomingExpensivePeriod) {
        ...
        if (hoursUntilExpensive < thermalInertiaHours) {
          ...
          recommendation = {
            ...defaultRecommendation,
            recommendedStartTime: DateTime.fromISO(upcomingExpensivePeriod.time)
              .minus({ hours: thermalInertiaHours }).toISO(),
        ...
        if (hoursUntilCheap < 3 && currentTemp > targetTemp - 1.5) {
          ...
          recommendation = {
            ...
            recommendedStartTime: nextCheapPeriod.time,
